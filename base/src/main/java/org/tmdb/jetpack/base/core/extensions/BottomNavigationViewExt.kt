...
import org.tmdb.jetpack.base.R

/**
 * Manages the various graphs need for a [BottomNavigationView]
 *
...
fun BottomNavigationView.setupWithNavController(
    ...
    setOnNavigationItemSelectedListener { item ->
        // Don't do anything if the satate has already been saved.
...
//    setupItemReselected(graphIdToTagMap, fragmentManager)
    ...
    fragmentManager.addOnBackStackChangedListener {
        ...
        // Reset the graph if the current destination is not valid (happens when the back
